...
namespace MoreMountains.CorgiEngine
{
	...
	public class Health : MMMonoBehaviour, MMEventListener<HealthDeathEvent>
    {
        ...
        public bool shouldHaveRedFlicker = true; //Leo Monge: Need to ALWAYS bring it after update. This avoids unusual flickering of things that should not flicker by any mean. Need to remember to disable this in characters and bullets.
