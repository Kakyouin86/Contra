...
namespace MoreMountains.CorgiEngine
{
    ...
    public class Health : MMMonoBehaviour, MMEventListener<HealthDeathEvent>
    {
        ...
        public float
            flickerDuration =
                0.01f; //Leo Monge: Need to ALWAYS bring it after update. This will create a better flicker than the original.
        ...
        {
            _character = (AssociatedCharacter == null)
            ...
            float invincibilityDuration, Vector3 damageDirection, List<TypedDamage> typedDamages = null)
        {
            ...
            if (MasterHealth != null)
            {
                ...
                MasterHealth.Damage(damage, instigator, flickerDuration, invincibilityDuration, damageDirection,
                    typedDamages);
            ...
            if (FlickerSpriteOnHit)
            {
                ...
                if (_renderer != null)
                {
                    //StartCoroutine(MMImage.Flicker(_renderer, _initialColor, FlickerColor, 0.05f, flickerDuration));  //Leo Monge: Need to ALWAYS bring it after update. We avoid this horrible MMImage flicker.
                }
            }
        ...
        public virtual void Kill()
        {
            ...
            if (_character != null)
            {
                ...
                _character.GetComponent<CharacterHandleWeapon>()
                    .StopShooting(); //Leo Monge: Need to ALWAYS bring it after update. This is so you can't shoot while dead.
                _character.Reset();
        ...
        protected virtual void ComputeCharacterMovementMultipliers(List<TypedDamage> typedDamages)
        {
            ...
            foreach (TypedDamage typedDamage in typedDamages)
            {
                if (typedDamage.ApplyMovementMultiplier)
                {
                    ...
                    _characterHorizontalMovement?.ApplyContextSpeedMultiplier(typedDamage.MovementMultiplier,
        ...
        {
            // Check if _renderer is not null
            if (_renderer != null)
            {
                ...
                {
                    // Set the color to FlickerColor if _renderer.material is not null
                    ...
                    // Set the color back to initialColor if _renderer.material is not null
                    if (_renderer.material != null)
