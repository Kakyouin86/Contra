...
public class AdditionalCharacterHorizontalMovementOverride : CharacterHorizontalMovement
{
    protected override void HandleHorizontalMovement()
    {
            ...
            ))
        {
            ...
            {
                _movement.ChangeState(CharacterStates.MovementStates.Falling);//Leo Monge
            }
            else
            {
                _movement.ChangeState(CharacterStates.MovementStates.Jumping);//Leo Monge
            }
        }
        //{
